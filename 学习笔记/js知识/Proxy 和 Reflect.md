...
## [具有 “deleteProperty” 和其他捕捉器的受保护属性](https://zh.javascript.info/proxy#ju-you-deleteproperty-he-qi-ta-bu-zhuo-qi-de-shou-bao-hu-shu-xing)
...
## [带有 “has” 捕捉器的 “in range”](https://zh.javascript.info/proxy#dai-you-has-bu-zhuo-qi-de-inrange)
...
## [包装函数："apply"](https://zh.javascript.info/proxy#proxy-apply)
...
### [代理一个 getter](https://zh.javascript.info/proxy#dai-li-yi-ge-getter)
...
## [Proxy 的局限性](https://zh.javascript.info/proxy#proxy-de-ju-xian-xing)
...
## [参考资料](https://zh.javascript.info/proxy#can-kao-zi-liao)
...
## [总结](https://zh.javascript.info/proxy#zong-jie)
...
- 许多其他操作（完整列表请见本文开头部分和 [docs](https://developer.mozilla.org/zh/docs/Web/JavaScript/Reference/Global_Objects/Proxy)）。

这使我们能够创建“虚拟”属性和方法，实现默认值，可观察对象，函数装饰器等。

我们还可以将对象多次包装在不同的代理中，并用多个各个方面的功能对其进行装饰。

[Reflect](https://developer.mozilla.org/zh/docs/Web/JavaScript/Reference/Global_Objects/Reflect) API 旨在补充 [Proxy](https://developer.mozilla.org/zh/docs/Web/JavaScript/Reference/Global_Objects/Proxy)。对于任意 `Proxy` 捕捉器，都有一个带有相同参数的 `Reflect` 调用。我们应该使用它们将调用转发给目标对象。
